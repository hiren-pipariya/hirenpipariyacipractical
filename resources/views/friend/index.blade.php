...
<script>
        ...
        dtable = $('#skillTable').DataTable({
            ...
            columns: [
                ...
                },
                {
                    ...
                    "searchable": false,
                    "render": function(data) {
                        var element = `<a href='javascript:void(0);' class="unfriend-user" data-id="${data.id}">Unfriend</a>`;
                        return element;
                    }
                },
            ]
    ...
    $(document).on('click',".unfriend-user" ,function(e) {
      var id = $(this).data('id');
        $.ajax({
            url: "unfriend_user/" + id,
            type: "get",
            processData: false,
            cache: false,
