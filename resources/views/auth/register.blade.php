                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="file" class="form-control-file @error('photo') is-invalid @enderror" accept="image/*" name="photo" id="photo" required>
...
@push('script')
    <script>
        $('#photo').on('change', function() {
            if (this.files && this.files[0] && this.files[0].size/1024/1024 > 1) {
